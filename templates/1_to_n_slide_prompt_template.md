...
*   **Few-Shot 範例**：
    ...
    *   ❌ *落後/財務*：付費訂閱用戶數（無法指導產品改進 of 結果指標）。
...
*   **設計與稽核原則**：
    *   **指標拉動理由**：必須說明此指標如何作為優化槓桿拉動主產品的大盤北極星指標 (NSM)。
...
*   **Slide 1: 項目現狀 (Current Status)**
    ...
    *   *內容*：大字展示主產品當前的大盤指標與基準線（如每週活躍文件數為 42,000 份），**附帶明確的「採用理由與商業價值理由」**。
...
*   **Slide 7: 驗證計畫 (Validation Plan)**
    ...
    *   *內容*：
        *   第一層 (Top)：產品大盤北極星指標 (NSM) ＋ **設計與採用理由** `[⚠️ 請在此處更新您正確的主產品名稱及指標]`。
...
## Slide 7: [第七頁標題 - 驗證計畫]
*   驗證指標樹：
    *   產品大盤北極星指標 (NSM) [⚠️ 請在此處更新您正確的主產品名稱及指標]：[定義] ➔ 採用理由：[必須硬性說明]
    *   功能層成功指標 (FSM)：[定義] ➔ 採用理由：[必須硬性說明如何拉動大盤，避開高摩擦留言/點讚動作，採用低摩擦團隊瀏覽瀏覽代理行為]
...
| :--- | :--- | :--- | :--- | :--- |
| Slide 1 | [標題] | 🟢🟢🟢 (已對齊大盤 NSM，非自嗨且附帶採用理由) | 🟢🟢🟢 (通過理由) | 🟢 PASS |
...
| Slide 7 | [標題] | 🟢🟢🟢 (包含完整 3 層樹，且 NPS 護欄有進行雙重日誌配對，各指標皆附帶採用理由) | 🟢🟢🟢 (警告標籤已置入) | 🟢 PASS |
